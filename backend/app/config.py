...
class Settings(BaseSettings):
    ...
    # When set alongside USE_CLOUD_EMBEDDINGS=true, embeddings run via the
    # HF Inference API instead of locally — this eliminates the ~2 GB PyTorch
    # dependency and is required for deployment on storage-limited platforms
    # like Render's free tier.
    HUGGINGFACE_API_KEY: str = ""

    # Set to True in production (Render, Railway, etc.) to use cloud-based
    # embeddings. Leave False for local development with sentence-transformers.
